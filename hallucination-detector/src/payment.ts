...
export function getPaymentRequirement(): PaymentRequirement {
  ...
  return {
    ...
    resource: "https://hallucination-detector.fly.dev/mcp",
    description: "Scores AI-generated text for likely hallucinated facts. Detects fabricated precision, invented citations, temporal impossibilities, hedged authority, entity confusion, and overconfident absolutes. Returns a 0-1 risk score, verdict, and detailed signals.",
    ...
    outputSchema: {
      input: {
        ...
        required: ["text"],
        properties: {
          text: { type: "string", description: "The AI-generated text to analyze for hallucination signals" },
        },
      },
      output: {
        type: "object",
        properties: {
          score: { type: "number", description: "Hallucination risk score from 0 to 1" },
