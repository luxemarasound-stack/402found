...
<title>Multi-Agent Trust Verifier — 402Found.dev</title>
<style>
...
<h1>Multi-Agent Trust Verifier</h1>
<div class="price">$0.004 USDC/request</div>
<p>MCP endpoint for verify_agent_trust tool. Requires x402 payment (0.004 USDC on Base).</p>
<div class="links">
