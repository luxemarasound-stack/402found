...
<title>The Prospector — 402Found.dev</title>
<style>
...
<div class="price">$0.01 USDC/request</div>
<p>Generates valid agent-card.json files from stable structured sources. Pay-per-card via x402 (USDC on Base).</p>
<div class="links">
