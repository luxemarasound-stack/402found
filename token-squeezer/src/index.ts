...
<title>Token Squeezer — 402Found.dev</title>
<style>
...
<h1>Token Squeezer</h1>
<div class="price">$0.001 USDC/request</div>
<p>Compresses text into hyper-dense Reasoning Maps for LLM context windows. Pay-per-request via x402 (USDC on Base).</p>
<div class="links">
